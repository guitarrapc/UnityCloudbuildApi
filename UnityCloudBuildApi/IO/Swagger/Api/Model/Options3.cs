...
namespace UnityCloudBuildApi.IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Options3 :  IEquatable<Options3>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Options3);
        }

        /// <summary>
        /// Returns true if Options3 instances are equal
        /// </summary>
        /// <param name="other">Instance of Options3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Options3 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
